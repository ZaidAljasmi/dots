...
map("n", "<C-S-H>", "<cmd>vertical resize +2<CR>")
map("n", "<C-S-L>", "<cmd>vertical resize -2<CR>")
map("n", "<C-S-J>", "<cmd>resize -2<CR>")
map("n", "<C-S-K>", "<cmd>resize +2<CR>")
...
map("n", "<leader>fc", function()
    cmd("Explore " .. vim.fn.stdpath("config"))
end)
